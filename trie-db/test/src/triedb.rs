...
use reference_trie::{
	estimate_substrate_size_compact, estimate_substrate_size_count, test_layouts,
	ExampleCounterConfig, HashedValueNoExtThreshold, TestTrieCache, TestTrieCacheCounted,
};
use trie_db::{
...
fn test_record_value() {
	type L = HashedValueNoExtThreshold<33, ExampleCounterConfig>;
