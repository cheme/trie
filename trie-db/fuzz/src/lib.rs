...
fn test_failure4() {
	let data = [
		vec![0x2b,0x97,0xff,0x17,0x2b,0x17,0x20,0x20,0x23,0x0,0xff,0xff,0x0,0x0,0x0,0x0,0x0,0x0,0x1,0x0,],
		vec![0xa,0x98,0x9f,0x0,0xd,0x20,0x20,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x1,0x0,0x0,],
...
fn test_failure5() {
	let data = [
		vec![0x0,0xa,0x0,0x20,0x0,0x31,0x20,0x81,0xdc,0x0,0x20,0x1,0x0,0x0,0xc,0x2b,0x0,],
	];
	for data in data.iter() {
		fuzz_indexing_root_calc(
			data,
...
fn test_failure6() {
	let data = [
		vec![0x20,0x0,0x2,0x41,0x80,0x22,0x41,0x58,0x0,0x0,0x20,0x21,0xe0,0x0,0x20,0x40,0x20,0x20,0xe0,0x21,0x0,],
		vec![0x6,0x0,0x0,0x1,0x0,0x20,0x1,0x60,0x2a,0x0,0x0,0xff,0xa2,0x40,0x0,0xa2,0x0,0xa4,0x39,0xff,0x0,],
	];
	for data in data.iter() {
		fuzz_indexing_root_calc(
			data,
...
fn test_failure7() {
	let data = vec![
		vec![0x0,0x0,0x0,0x0,0x3,0xf0,0x23,0x23,0x22,0x23,0x23,0x23,0x23,0x23,0x25,0x27,0x41,0x41,0x0,0x26,0x0,0x0,0x20,0x2e,0x8b,0x8b,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x19,0xdb,0xea,0x0,0x61,0x61,0x3f,0x0,0x16,0x0,0x27,0x0,0x27,0x26,0x40,0x0,0x6f,0xf3,0xf6,0x0,0xff,0xf9,0x0,0x20,0x32,0x31,0xe1,0x0,0x20,0x29,0x12,0x0,0x0,0x0,0x7a,0x0,0x0,0x0,0x7e,0x33,0xff,0xc5,0x2a,0x27,],
		vec![0xe1,0xc2,0xc2,0xc2,0xc2,0xc2,0xc2,0xc2,0xca,0xc2,0xc2,0xc2,0x3c,0xc2,0x3c,0x3d,0x6,0x0,0x0,0x0,0x6,0x33,0xe9,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x29,0x9d,0x7,0x9,0x8c,0x0,0x0,0x0,0x0,0xe1,0xe1,0x41,0x0,0x20,0xe1,0x0,0xd9,0x30,0x85,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0x0,0x67,0x0,0x20,],
	];
	for data in data.iter() {
		fuzz_indexing_root_calc(
			data,
			Some(reference_trie::DepthIndexes::new(&[3, 6])),
			true,
			false,
		);
	}
